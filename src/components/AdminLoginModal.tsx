...
import { X, Lock, ShieldCheck, KeyRound, AlertCircle, Eye, EyeOff, User } from 'lucide-react';
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3.5 py-2.5 rounded-xl border border-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-[#0984E3] bg-slate-50 font-medium text-slate-900"
                placeholder="info@maxexecutivetires.org"
                required
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="text-[11px] text-[#0984E3] hover:text-[#0770c2] font-semibold flex items-center gap-1 transition"
                title={showPassword ? "Hide password words" : "View password words"}
              >
                {showPassword ? <EyeOff className="w-3.5 h-3.5" /> : <Eye className="w-3.5 h-3.5" />}
                <span>{showPassword ? 'Hide Words' : 'Show Words'}</span>
              </button>
            </div>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 rounded-xl border border-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-[#0984E3] bg-slate-50 font-medium text-slate-900"
              ...
              <button
                ...
                aria-label={showPassword ? "Hide password words" : "View password words"}
                title={showPassword ? "Hide words" : "View words"}
              >
                {showPassword ? (
                  <EyeOff className="w-4 h-4 text-[#0984E3]" />
                ) : (
          ...
          <div className="flex items-center justify-between text-xs pt-0.5">
            <label className="flex items-center gap-2 cursor-pointer select-none text-slate-600 hover:text-slate-800">
              <input
                ...
                className="w-4 h-4 rounded text-[#0984E3] border-slate-300 focus:ring-[#0984E3]"
              />
              <span className="font-medium text-[11px]">Show password words while typing</span>
            </label>
            <span className="text-[10px] text-slate-400 font-mono">Default: maxexecutivetires</span>
          </div>
